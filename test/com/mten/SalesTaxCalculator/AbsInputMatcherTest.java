...
public class AbsInputMatcherTest extends TestCase {
	////////////////////////
	//	Fields
	////////////////////////
	...
	public void setup() {
		...
		input_3 = "1 Other thing that does not smell 5.55";
	...
	public void testProductFinder() {
		setup();
		userInput = (im.productArray(input_1));
		pFinderResult = im.productFinder(userInput);
		assertEquals("Imported Box of stuff", pFinderResult);
		
		setup();
		userInput = (im.productArray(input_3));
		pFinderResult = im.productFinder(userInput);
		assertEquals("Other thing that does not smell", pFinderResult);
